...
const data = [
  ...
  },
  {
    ...
    age: 52,
    address:
      "这是一段很长的文本，需要长到足以让该 column 显示出...。妙木山的蛤蟆仙人助小自来也一臂之力。妙木山的蛤蟆仙人助小自来也一臂之力。妙木山的蛤蟆仙人助小自来也一臂之力。"
  }
];
...
storiesOf("Table", module)
  ...
  .add("no data", () => (
    <Table {...props} data={[]} columns={[]} {...actions} />
  ))
  .add("hide a column", () => {
  ...
  .add("adaptive pageSize", () => {
    return (
      <>
        <p>
          <em style={{ color: "red" }}>[INVALID, NOT EXIST in editor]</em> too
          small height, less than (header + pagination)
        </p>
        <Table {...props} height={82} {...actions} />
        <p>
          <em style={{ color: "red" }}>[INVALID, NOT EXIST in editor]</em>{" "}
          height=(21+2*12+1)+(24+2*16)=45+56=102, equal to (header + pagination)
        </p>
